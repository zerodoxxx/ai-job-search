...
**Worked example:** a candidate whose Languages table lists Hindi (Native) and English (Fluent). A posting requiring "fluent German" → **FAIL**, German isn't declared at all. A posting requiring "fluent English" → **PASS**, English is declared as Fluent.
...
**Strong match areas:** Python, PyTorch, TensorFlow, FastAPI, Docker, Kubernetes, Apache Kafka, Apache Airflow, RAG, Multi-Agent LLMs, Vector DBs, SQL, Distributed Systems
**Moderate match areas:** C++, Databricks, Snowflake, BigQuery, Spark, MongoDB
**Weak match areas:** Frontend UI frameworks (React/Vue/Angular), Mobile development, Deep hardware RTL/Verilog
...
**Strong:** Production ML/LLM Engineering, Backend API Engineering (FastAPI/REST), Distributed Stream & Data Pipelines (Kafka/Airflow), High-throughput retail/financial platforms
**Moderate:** Quantitative modeling, deep data analytics, DevOps infrastructure
**Entry-level:** Embedded systems, compiler engineering
...
- Within commute range (Bengaluru onsite/hybrid): PASS
- Remote (India or global): PASS
- Requires unassisted international relocation: FLAG (discuss with user)
...
**Career goals:**
- Lead production AI/LLM systems and multi-agent workflow engines
- Scale high-throughput backend services and distributed data pipelines
- Grow into Staff MLE / Principal Engineer roles with high technical agency

**Motivation filter:** Evaluate not just whether you *can* do the tasks, but whether the tasks will *energize* you. Consider:
- Tasks that energize: Building and deploying production AI/LLM pipelines, performance & latency optimization, system architecture design
- Tasks that drain: Low-agency maintenance-only roles, purely bureaucratic processes, lack of production ownership
- Non-task factors: leadership style, department culture, company values, degree of autonomy

**Life situation alignment:** Consider personal constraints:
- **Security**: Stable high-growth engineering organization
- **Flexibility**: Hybrid or remote flexibility
- **Professional development**: High-ownership production systems, modern AI stack
